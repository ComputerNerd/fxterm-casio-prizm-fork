...
#endif 
//I disagree with calling it SCIF2 if it were there would be an additional 0x20000 offset than the address listed in Simon's documentation unless he missed the ones above it
#define SCIF0 (*(volatile struct st_scif0 *)0xA4410000)/* SCIF0 Address */
